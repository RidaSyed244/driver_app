...
class DeliveredOrders extends ConsumerStatefulWidget {
  const DeliveredOrders({Key? key});

  @override
  ConsumerState<DeliveredOrders> createState() => _DashboardState();
}

class _DashboardState extends ConsumerState<DeliveredOrders> {
  List fetchAllOrders = [];
